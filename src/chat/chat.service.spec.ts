...
describe('ChatService - Title Generation', () => {
    ...
    beforeEach(async () => {
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                ...
                { provide: getRepositoryToken(ChatMessageHistory), useValue: mockChatMessageRepo }, // Re-use msg repo mock for simplicity as history likely has similar save/find interface or is not used in strictly tested paths
    ...
    describe('getSessionMessages', () => {
        ...
        it('should handle broken chains / missing parents gracefully', async () => {
            ...
            const messages = [
                { id: 'm1', parentId: 'ROOT', createdAt: new Date(mockDate.getTime() - 2000) },
                { id: 'm2', parentId: 'MISSING_ID', createdAt: new Date(mockDate.getTime() - 1000) }, // Broken chain
