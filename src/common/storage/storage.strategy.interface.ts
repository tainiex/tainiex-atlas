...
export interface StorageStrategy {
     ...
     */
    uploadFile(buffer: Buffer, filename: string, folder: string, contentType: string): Promise<string>;
     ...
     */
    uploadFromUrl(url: string, folder: string, filenamePrefix: string): Promise<string | null>;
     ...
     */
    getSignedUrl(filename: string, expiresInMinutes?: number): Promise<string | null>;
