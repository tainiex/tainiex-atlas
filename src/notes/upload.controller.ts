...
export class UploadController {
    ...
    async uploadImage(
        ...
        return this.handleUpload(req.user.id, noteId, file, 'image');
    }
    ...
    async uploadVideo(
        ...
        return this.handleUpload(req.user.id, noteId, file, 'video');
    }
    ...
    async uploadFile(
        ...
        return this.handleUpload(req.user.id, noteId, file, 'file');
    }
    ...
    private async handleUpload(
        ...
        const canEdit = await this.blocksService['notesService'].canEdit(noteId, userId);
        if (!canEdit) {
