...
export class VersionsController {
     ...
     */
    @Get('blocks/:blockId')
    async getBlockHistory(@Param('blockId') blockId: string, @Query('limit') limit?: string) {
        return this.versionsService.getBlockHistory(blockId, limit ? parseInt(limit) : undefined);
    }
