...
describe('WebSocketStateMachineService', () => {
    ...
    beforeEach(async () => {
        ...
        service = module.get<WebSocketStateMachineService>(WebSocketStateMachineService);
    });
    ...
    describe('createMachine', () => {
        ...
        it('should have all required states', () => {
            ...
            const states = machine.config.states ? Object.keys(machine.config.states) : [];
    ...
    describe('state transitions', () => {
        ...
        it('should handle AUTH_FAILED and transition appropriately', () => {
            ...
            expect(['authenticating', 'error', 'connecting', 'disconnected']).toContain(
                snapshot.value
            );
        });
