...
// Updated to match v0.0.34 discriminated union type
export const ChatStreamEventSchema: z.ZodType<ChatStreamEvent> = z.discriminatedUnion('type', [
    ...
    z.object({ type: z.literal('tool_call'), tool: z.string(), args: z.any() }),
    z.object({ type: z.literal('tool_result'), tool: z.string(), result: z.any() }),
    z.object({ type: z.literal('answer_chunk'), content: z.string() }),
    z.object({ type: z.literal('done'), title: z.string().optional() }),
